...
p0 =[10., 4., 40., 0.5, 10., 11., 0.05]
bounds = [(0.5,None), (0., 4.), (0,None), (0,None), (0,None), (0, None), (0, None)]
...
dfunc_c2 = a1*spit_x**(a2)*log(spit_x)*np.exp(-a3*f2)*np.exp(-a6*t_hielo)
...
file400 = open('continuum_spitzer_other_method_ESO244_G12_plus_water.dat','w+')
